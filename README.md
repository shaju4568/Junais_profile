...
<head>
  ...
  <title>Junais Shajahan MK - Data Analyst Portfolio</title>
  ...
  <style>
    * {margin: 0; padding: 0; box-sizing: border-box;}
    ...
    section {max-width: 1000px; margin: 2rem auto; padding: 1.5rem;}
 
    h2 {
      font-size: 1.8rem; color: #1e3a8a;
      border-left: 5px solid #2563eb;
      padding-left: 0.6rem; margin-bottom: 1rem;
    }
    .card {
      background: white;
      padding: 1.5rem;
